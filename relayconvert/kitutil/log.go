...
// redirects them into its logging system at startup; standalone llmdock users
// get stderr defaults.
...
func LogInfo(message string) {
	...
	fmt.Fprintf(os.Stderr, "[llmdock] %s\n", message)
}
...
func LogError(message string) {
	...
	fmt.Fprintf(os.Stderr, "[llmdock] ERROR %s\n", message)
}
...
func LogSystemError(message string) {
	...
	fmt.Fprintf(os.Stderr, "[llmdock] SYSTEM ERROR %s\n", message)
}
